...
class ScreenHelper extends StatelessWidget {
  ...
  static bool isMobile (BuildContext context) => MediaQuery.of(context).size.width < 900.0;

  static bool isTablet (BuildContext context) => MediaQuery.of(context).size.width >= 900.0 && MediaQuery.of(context).size.width < 1200.0;
